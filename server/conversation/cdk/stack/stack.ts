...
export class ConversationStack extends Stack {
    constructor(scope: Construct, id: string, props?: StackProps) {
        ...
        const getConversationOnDateLambdaId = "getConversationOnDateLambda";
        const getConversationOnDate = new NodejsFunction(this, getConversationOnDateLambdaId, {
            entry: "src/lambda.ts",
            handler: "getConversationOnDateHandler",
        ...
        getConversationOnDate.addFunctionUrl({
